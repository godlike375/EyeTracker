...
class GradientIntersect:
    ...
    def locate(self, image, sigma=3, accuracy=1):
    ...
    def track(self, image, prev, sigma=3, radius=9, distance=3):
        py, px = prev
...
class IsophoteCurvature:
    ...
    def locate(self, image):
        ...
        center_map = cv2.GaussianBlur(center_map, (self.blur, self.blur), 0)
        blurred = cv2.GaussianBlur(image, (self.blur, self.blur), 0)
